    ...
    <footer className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 pb-6">
      <div className="max-w-6xl mx-auto px-4 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-gray-500 dark:text-gray-400">
          <p>&copy; {new Date().getFullYear()} DevKit. All tools run client-side. Press <kbd className="px-1 py-0.5 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded text-[10px]">?</kbd> for shortcuts.</p>
